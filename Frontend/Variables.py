...
directory_risk = (Path(dir_in)/ 'adm_risk')
directory_ADP = (Path(dir_in)/ 'ADP')
directory_sigemet = (Path(dir_in)/ 'Sigemet')
directory_social_programs = (Path(dir_in)/ 'Social_programs')