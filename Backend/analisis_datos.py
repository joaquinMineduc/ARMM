...
from Frontend.Variables import directory_sigemet
...
def data_analisis():
   ...
   df = create_dataframe(Path(directory_sigemet)/'indicadores.xls', None, 1)
...
# Crea el df que da origen al anexo de indicadore
def create_df_anexo():
   df = data_analisis()
   # Se ramifica el data frame para filtrar todos los ponderados
...
# Filtra los datos del anexo a todos los indicadores que tengan entre riesgo medio y alto
def create_df_anexo_risk():
