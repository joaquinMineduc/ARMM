...
df_grap_CDC = create_query(df_grap_CDC, ['Tipo', 'Nivel'], ['CDC', 'NC'], ['and','and'], ['==','=='], columns_filter)
...
df_grap_reg = create_query(df_grap_reg, ['Tipo', 'Nivel'], ['CDC', 'Regiones'], ['and','and'],['==','=='], columns_filter)
