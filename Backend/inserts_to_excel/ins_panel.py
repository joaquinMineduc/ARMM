...
def insert_data_panel():
    df_chart_H = create_chart_H()
    df_chart_CDC = create_chart_CDC()
    df_chart_reg = create_chart_CDC_reg()
    df_chart_PMG = create_chart_PMG()
    df_principal_panel = create_df_type_risk()
