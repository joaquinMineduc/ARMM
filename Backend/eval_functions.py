...
def create_df_eval_reg():
    # =============== Tratamiento DF regional ==================================
    df_regional = create_dataframe(Path(directory_sigemet)/'eval.xls',
...
def create_df_eval_NC():
    # ================= Tratamiento DF NC =======================================
    df_NC = create_dataframe(Path(directory_sigemet)/'eval.xls',
...
def eval_ptr():
    ...
    df_NC_ptr = create_dataframe(Path(directory_sigemet)/'eval.xls',
        'Eval. interna por variable', 2)
